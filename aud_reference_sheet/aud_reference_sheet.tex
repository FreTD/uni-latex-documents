...
\section{Graphen}
	...
	\subsection{Breadth-First Search}
		...
		\vspace{1cm}
		\subsubsection{Code mit Beispiel}
			\begin{minipage}{0.5\textwidth}
				\begin{center}
					\includegraphics[scale=0.4]{BFS_Code.jpg}
				\end{center}
			\end{minipage}
			\hspace{1cm}
			\begin{minipage}{0.45\textwidth}
				\begin{center}
					\includegraphics[scale=0.3]{BFS_CodeSample01.jpg} \\
					\includegraphics[scale=0.3]{BFS_CodeSample02.jpg} \\
					\includegraphics[scale=0.3]{BFS_CodeSample03.jpg} \\
					\includegraphics[scale=0.3]{BFS_CodeSample04.jpg} \\
				\end{center}
			\end{minipage}
